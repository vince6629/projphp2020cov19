                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-12">
                        <a href="index.php?uc=etatutilisateur&action=selectionnerutilisateur"
                           class="btn btn-primary btn-lg" role="button">
                            <span class="glyphicon glyphicon-list-alt"></span>
                            <br>Etat des frais utilisateurs pour validation</a>
                        <a href="index.php?uc=etatutilisateur2&action=selectionnerutilisateur"
                           class="btn btn-primary btn-lg" role="button">
                            <span class="glyphicon glyphicon-list-alt"></span>
                            <br>Etat de validation des frais utilisateurs (modif)</a>
                    </div>
                </div>
            </div>
        </div>
